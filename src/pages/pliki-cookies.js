      ...
      <Layout background={true} bgSide='left'>
        ...
        <div className="container">
            <ol>
                ...
                <li>Podmiotem zamieszczającym na urządzeniu końcowym Użytkownika Serwisu pliki cookies oraz uzyskującym do nich dostęp jest operator Serwisu Brilliant Car - Studio Detailingu z siedzibą pod adresem ul. Jurajska 20, Modlnica.</li>
